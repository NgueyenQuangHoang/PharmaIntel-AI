...
namespace PharmaIntel.Infrastructure.Migrations
{
    ...
    [Migration("20260526010702_AddConsultations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaIntel.Core.Entities.Consultation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("PharmacistId", "ScheduledAt")
                    ...
                    b.ToTable("consultations", null, t =>
                        {
                            t.HasCheckConstraint("CK_consultations_status", "[status] IN ('pending','accepted','rejected','completed','cancelled')");
                        });
                });
            ...
            modelBuilder.Entity("PharmaIntel.Core.Entities.MedicationReminder", b =>
                {
                    ...
                    b.ToTable("medication_reminders", null, t =>
                        {
                            t.HasCheckConstraint("CK_medication_reminders_date_range", "[end_date] IS NULL OR [end_date] >= [start_date]");
            ...
            modelBuilder.Entity("PharmaIntel.Core.Entities.PrescriptionItem", b =>
                {
                    ...
                    b.HasIndex("PrescriptionId", "IsDispensed")
            ...
            modelBuilder.Entity("PharmaIntel.Core.Entities.RefreshToken", b =>
                {
                    ...
                    b.ToTable("refresh_tokens", null, t =>
                        {
                            t.HasCheckConstraint("CK_refresh_tokens_revoked_reason", "[revoked_reason] IS NULL OR [revoked_reason] IN ('rotated','logout','theft_detected')");
                        });
                });
                    ...
                    b.ToTable("users", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_users_role", "[role] IN ('user','admin','pharmacist')");
                        });
                });
            ...
            modelBuilder.Entity("PharmaIntel.Core.Entities.Pharmacist", b =>
                {
                    b.HasOne("PharmaIntel.Core.Entities.User", "User")
                        ...
                        .HasForeignKey("PharmaIntel.Core.Entities.Pharmacist", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
